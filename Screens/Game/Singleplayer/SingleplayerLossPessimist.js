    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text style={{marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}>وقعتِ في غرفة المحبّطين!</Text>
          ...
          <Image
            source={require("../../../../assets/JoudLostP.png")}
            style={{
              justifyContent: "center",
